//! Behavior coverage for generated views against `TestEnv`'s mock host.
//!
//! Representative transaction, ledger, and inner-object views cover the
//! shared generated template, including presence rules, type checks, and slot
//! ownership.
...
// These fixtures build complete serialized objects, not value-only fields.
const STI_VL: u32 = 7;
...
// Inner STObjects include an object terminator. sfEmitCallback is omitted to
// exercise optional-field behavior.
...
impl Views {
    ...
    fn slot_constructor_rejects_the_wrong_type(&self) -> HookResult {
        ...
        // More than 255 rejected constructions prove the consumed root is cleared.
        for _ in 0..300 {
