...
| 16 | `typed-results` | typed entry returns (`HookResult`, `?`, a `hook_errors!` message clause) alongside a legacy `i64` entry in the same chain | [Accept, Rollback, and Errors](../concepts/errors.md#typed-entry-returns-hookresult) |
