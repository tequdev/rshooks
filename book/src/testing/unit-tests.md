...
| Util / Keylets | `util_sha512h`, `util_accid`, `util_raddr`, `util_verify`, `util_keylet`/`util_keylet_into`, and all 26 typed `keylet_*` helpers plus their `keylet_*_into` out-param twins — see [Keylets](../data/keylets.md) |
